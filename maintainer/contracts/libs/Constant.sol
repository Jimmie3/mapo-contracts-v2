...
library Constant {
    ...
    bytes32 internal constant OBSERVE_MAX_DELAY_BLOCK = keccak256(bytes("OBSERVE_MAX_DELYA_BLOCK"));
    ...
    bytes32 internal constant KEY_GEN_DELAY_SLASH_POINT = keccak256(bytes("KEY_GEN_DELAY_SLASY_POINT"));
