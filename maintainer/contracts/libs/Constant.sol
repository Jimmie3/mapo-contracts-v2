...
library Constant {
    // uint128 internal constant OBSERVE_MAX_DELYA_BLOCK = 500;
    ...
    bytes32 internal constant OBSERVE_MAX_DELYA_BLOCK = keccak256(bytes("OBSERVE_MAX_DELYA_BLOCK"));
    ...
    bytes32 internal constant KEY_GEN_DELAY_SLASY_POINT = keccak256(bytes("KEY_GEN_DELAY_SLASY_POINT"));
